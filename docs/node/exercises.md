...
* Масиви - тренування
  ...
  * 🚧 Завдання на додавання та видалення з масиву (парність дужок)
* Масиви - шифри
...
Написати функцію, яка буде перевіряти вираз на коректність відкритих да закритих дужок. 
...
#### Виклик функції
```javascript
console.log(hasValidParentheses('()(') ? 'OK' : 'ERROR')
```
